public class Main {
    public static void main(String[] args) {
        ...
        // 좌석 예약
        System.out.println("정동찬님 이름으로 A5부터 2개의 좌석 예약: " + (t.reserve("김신의", 'A', 5, 2) ? "성공" : "실패"));
        System.out.println("정지현님 이름으로 C1부터 3개의 좌석 예약: " + (t.reserve("이윤수", 'C', 1, 3) ? "성공" : "실패"));
        ...
        System.out.println("정지현님의 좌석 취소: 총 " + t.cancel("정지현") + "개의 좌석이 취소되었습니다.");
